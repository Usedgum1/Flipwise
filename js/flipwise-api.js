...
(function() {
  ...
  function processMoneyMakers(prices, iconById, buyLimits) {
    ...
    addTile('knife', 'Dragon Knife Cleaning', bestKnifeProfit != null ? bestKnifeProfit : 0, 'gp', { knives: knivesList, best_knife: bestKnifeName, tax: knifeTax });
    ...
    addTile('soul_rune', 'Buying Soul Runes', soulProfit, 'gp', { ge_buy: soulPriceRaw, ge_buy_after_tax: soulPriceAfterTax, tax: soulTax, ge_buy_icon: iconById[String(F.SOUL_RUNE_ID || 566)] });
